    ...
    <div className={cn()} ref={layout}>
      <div className={cn('frame')} ref={frame}>
        <div className={cn('head')}>
          <h1 className={cn('title')}>{props.multilingualText.title[props.language]}</h1>
          <button className={cn('close')} onClick={props.onClose}>{props.multilingualText.buttonclose[props.language]}</button>
        </div>
