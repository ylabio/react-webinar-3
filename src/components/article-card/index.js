  ...
  return (
    <div className={cn()}>
      ...
      <div className={cn('prop')}>
        <div className={cn('label')}>{t('articleCard.country')}</div>
        <div className={cn('value')}>{article.madeIn?.title} ({article.madeIn?.code})</div>
      </div>
      <div className={cn('prop')}>
        <div className={cn('label')}>{t('articleCard.category')}</div>
        <div className={cn('value')}>{article.category?.title}</div>
      </div>
      <div className={cn('prop')}>
        <div className={cn('label')}>{t('articleCard.year')}</div>
        <div className={cn('value')}>{article.edition}</div>
      </div>
      <div className={cn('prop', {size: 'big'})}>
        <div className={cn('label')}>{t('articleCard.price')}</div>
