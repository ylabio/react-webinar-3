...
export function formatPrice(price, locale = 'ru-RU', currency = 'RUB') {
  return price.toLocaleString(locale, {style: 'currency', currency: currency, minimumFractionDigits: 0});
}
